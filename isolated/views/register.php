  ...
  <div class="register-cage">
    ...
    <form id="register-form" method="post" action="javascript:void(0);">
      <table class="reg-form-table">
        ...
        <tbody>
          <tr>
            <td><span class="req-span">*</span></td>
            <td>First Name</td>
            <td>:</td>
            <td><input type="text" name="first_name" required="1"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>Username</td>
            <td>:</td>
            <td><input type="text" name="username" required="1"/></td></tr>
          <tr>
            <td><span class="req-span">*</span></td>
            <td>Email</td>
            <td>:</td>
            <td><input type="email" name="email" required="1"/></td></tr>
          <tr>
            <td><span class="req-span">*</span></td>
          ...
          <tr>
            ...
            <td>:</td>
            <td><input type="password" name="cpassword" required="1"/></td>
          </tr>
          <tr>
            <td colspan="4" align="center" class="td-tcenter">Captcha</td>
          </tr>
          <tr>
            <td colspan="4" align="center" class="td-tcenter">
              <div class="submit-cage">
